...
SOFA_DIR=/usr/sofa/bin/testing/ci_test
...
function show_usage()
{
    echo "Usage: undeploy_sofaCI.sh [version] $version [release] $release"
}
...
echo "$0: undeploy SOFA CI version=$version release=$release"
