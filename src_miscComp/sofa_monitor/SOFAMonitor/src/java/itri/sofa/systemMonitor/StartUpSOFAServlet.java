 ...
 * @author A40385
 */
@WebServlet(name = "StartUpSOFAServlet", urlPatterns = {"/StartUpSOFAServlet"})
public class StartUpSOFAServlet extends HttpServlet{
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            JSONObject startupData = sofaAPI.startupSOFA();
            ...
            if(startupData == null){
                ...
                returnJSON = startupData;
                returnJSON.put(Key.ERR_CODE, Status.ERR_CODE_OK);
            }
            out.print(returnJSON.toString());
        } catch (JSONException ex) {
            Logger.getLogger(StartUpSOFAServlet.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }  
