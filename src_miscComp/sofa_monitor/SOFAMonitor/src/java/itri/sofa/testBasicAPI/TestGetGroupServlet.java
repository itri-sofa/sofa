 ...
 * @author A40385
 */
@WebServlet(name = "TestGetGroupServlet", urlPatterns = {"/TestGetGroupServlet"})
public class TestGetGroupServlet extends HttpServlet{
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            JSONObject diskSMARTData = sofaAPI.getGroups();
            returnJSON = diskSMARTData;
            returnJSON.put(Key.ERR_CODE, Status.ERR_CODE_OK);
            out.print(returnJSON.toString());
        } catch (JSONException ex) {
            Logger.getLogger(TestGetGroupServlet.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }  
