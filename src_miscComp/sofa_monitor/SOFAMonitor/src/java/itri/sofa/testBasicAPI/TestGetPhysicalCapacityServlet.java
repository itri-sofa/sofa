 ...
 * @author A40385
 */
@WebServlet(name = "TestGetPhysicalCapacityServlet", urlPatterns = {"/TestGetPhysicalCapacityServlet"})
public class TestGetPhysicalCapacityServlet extends HttpServlet{
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            JSONObject diskSMARTData = sofaAPI.getPhysicalCapacity();
            returnJSON = diskSMARTData;
            returnJSON.put(Key.ERR_CODE, Status.ERR_CODE_OK);
            out.print(returnJSON.toString());
        } catch (JSONException ex) {
            Logger.getLogger(TestGetPhysicalCapacityServlet.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }  
