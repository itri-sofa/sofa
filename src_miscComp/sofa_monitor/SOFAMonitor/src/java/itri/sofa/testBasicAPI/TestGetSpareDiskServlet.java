 ...
 * @author A40385
 */
@WebServlet(name = "TestGetSpareDiskServlet", urlPatterns = {"/TestGetSpareDiskServlet"})
public class TestGetSpareDiskServlet extends HttpServlet{
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            JSONObject diskSMARTData = sofaAPI.getSparedDisks();
            returnJSON = diskSMARTData;
            returnJSON.put(Key.ERR_CODE, Status.ERR_CODE_OK);
            out.print(returnJSON.toString());
        } catch (JSONException ex) {
            Logger.getLogger(TestGetSpareDiskServlet.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }  
