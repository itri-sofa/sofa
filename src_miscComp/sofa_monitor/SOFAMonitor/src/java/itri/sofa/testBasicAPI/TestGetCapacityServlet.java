 ...
 * @author A40385
 */
@WebServlet(name = "TestGetCapacityServlet", urlPatterns = {"/TestGetCapacityServlet"})
public class TestGetCapacityServlet extends HttpServlet{
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            JSONObject diskSMARTData = sofaAPI.getCapacity();
            returnJSON = diskSMARTData;
            returnJSON.put(Key.ERR_CODE, Status.ERR_CODE_OK);
            out.print(returnJSON.toString());
        } catch (JSONException ex) {
            Logger.getLogger(TestGetCapacityServlet.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }  
